...
const _: () = {
    ["Size of String"][::std::mem::size_of::<String>() - 8usize];
    ["Alignment of String"][::std::mem::align_of::<String>() - 4usize];
    ["Offset of field: String::ptr"][::std::mem::offset_of!(String, ptr) - 0usize];
    ["Offset of field: String::len"][::std::mem::offset_of!(String, len) - 4usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of AllocatorVtable"][::std::mem::size_of::<AllocatorVtable>() - 16usize];
    ["Alignment of AllocatorVtable"][::std::mem::align_of::<AllocatorVtable>() - 4usize];
    ...
    ["Offset of field: AllocatorVtable::resize"]
        [::std::mem::offset_of!(AllocatorVtable, resize) - 4usize];
    ["Offset of field: AllocatorVtable::remap"]
        [::std::mem::offset_of!(AllocatorVtable, remap) - 8usize];
    ["Offset of field: AllocatorVtable::free"]
        [::std::mem::offset_of!(AllocatorVtable, free) - 12usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Allocator"][::std::mem::size_of::<Allocator>() - 8usize];
    ["Alignment of Allocator"][::std::mem::align_of::<Allocator>() - 4usize];
    ["Offset of field: Allocator::ctx"][::std::mem::offset_of!(Allocator, ctx) - 0usize];
    ["Offset of field: Allocator::vtable"][::std::mem::offset_of!(Allocator, vtable) - 4usize];
};
...
const _: () = {
    ["Size of DeviceAttributesPrimary"]
        [::std::mem::size_of::<DeviceAttributesPrimary>() - 136usize];
    ["Alignment of DeviceAttributesPrimary"]
        [::std::mem::align_of::<DeviceAttributesPrimary>() - 4usize];
    ...
    ["Offset of field: DeviceAttributesPrimary::num_features"]
        [::std::mem::offset_of!(DeviceAttributesPrimary, num_features) - 132usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of DeviceAttributes"][::std::mem::size_of::<DeviceAttributes>() - 148usize];
    ["Alignment of DeviceAttributes"][::std::mem::align_of::<DeviceAttributes>() - 4usize];
    ...
    ["Offset of field: DeviceAttributes::secondary"]
        [::std::mem::offset_of!(DeviceAttributes, secondary) - 136usize];
    ["Offset of field: DeviceAttributes::tertiary"]
        [::std::mem::offset_of!(DeviceAttributes, tertiary) - 144usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of GridRef"][::std::mem::size_of::<GridRef>() - 12usize];
    ["Alignment of GridRef"][::std::mem::align_of::<GridRef>() - 4usize];
    ["Offset of field: GridRef::size"][::std::mem::offset_of!(GridRef, size) - 0usize];
    ["Offset of field: GridRef::node"][::std::mem::offset_of!(GridRef, node) - 4usize];
    ["Offset of field: GridRef::x"][::std::mem::offset_of!(GridRef, x) - 8usize];
    ["Offset of field: GridRef::y"][::std::mem::offset_of!(GridRef, y) - 10usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Selection"][::std::mem::size_of::<Selection>() - 32usize];
    ["Alignment of Selection"][::std::mem::align_of::<Selection>() - 4usize];
    ["Offset of field: Selection::size"][::std::mem::offset_of!(Selection, size) - 0usize];
    ["Offset of field: Selection::start"][::std::mem::offset_of!(Selection, start) - 4usize];
    ["Offset of field: Selection::end"][::std::mem::offset_of!(Selection, end) - 16usize];
    ["Offset of field: Selection::rectangle"]
        [::std::mem::offset_of!(Selection, rectangle) - 28usize];
};
...
const _: () = {
    ["Size of KittyGraphicsPlacementRenderInfo"]
        [::std::mem::size_of::<KittyGraphicsPlacementRenderInfo>() - 48usize];
    ["Alignment of KittyGraphicsPlacementRenderInfo"]
        [::std::mem::align_of::<KittyGraphicsPlacementRenderInfo>() - 4usize];
    ...
    ["Offset of field: KittyGraphicsPlacementRenderInfo::pixel_width"]
        [::std::mem::offset_of!(KittyGraphicsPlacementRenderInfo, pixel_width) - 4usize];
    ["Offset of field: KittyGraphicsPlacementRenderInfo::pixel_height"]
        [::std::mem::offset_of!(KittyGraphicsPlacementRenderInfo, pixel_height) - 8usize];
    ["Offset of field: KittyGraphicsPlacementRenderInfo::grid_cols"]
        [::std::mem::offset_of!(KittyGraphicsPlacementRenderInfo, grid_cols) - 12usize];
    ["Offset of field: KittyGraphicsPlacementRenderInfo::grid_rows"]
        [::std::mem::offset_of!(KittyGraphicsPlacementRenderInfo, grid_rows) - 16usize];
    ["Offset of field: KittyGraphicsPlacementRenderInfo::viewport_col"]
        [::std::mem::offset_of!(KittyGraphicsPlacementRenderInfo, viewport_col) - 20usize];
    ["Offset of field: KittyGraphicsPlacementRenderInfo::viewport_row"]
        [::std::mem::offset_of!(KittyGraphicsPlacementRenderInfo, viewport_row) - 24usize];
    ["Offset of field: KittyGraphicsPlacementRenderInfo::viewport_visible"]
        [::std::mem::offset_of!(KittyGraphicsPlacementRenderInfo, viewport_visible) - 28usize];
    ["Offset of field: KittyGraphicsPlacementRenderInfo::source_x"]
        [::std::mem::offset_of!(KittyGraphicsPlacementRenderInfo, source_x) - 32usize];
    ["Offset of field: KittyGraphicsPlacementRenderInfo::source_y"]
        [::std::mem::offset_of!(KittyGraphicsPlacementRenderInfo, source_y) - 36usize];
    ["Offset of field: KittyGraphicsPlacementRenderInfo::source_width"]
        [::std::mem::offset_of!(KittyGraphicsPlacementRenderInfo, source_width) - 40usize];
    ["Offset of field: KittyGraphicsPlacementRenderInfo::source_height"]
        [::std::mem::offset_of!(KittyGraphicsPlacementRenderInfo, source_height) - 44usize];
};
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of TerminalOptions"][::std::mem::size_of::<TerminalOptions>() - 8usize];
    ["Alignment of TerminalOptions"][::std::mem::align_of::<TerminalOptions>() - 4usize];
    ...
    ["Offset of field: TerminalOptions::max_scrollback"]
        [::std::mem::offset_of!(TerminalOptions, max_scrollback) - 4usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of FormatterScreenExtra"][::std::mem::size_of::<FormatterScreenExtra>() - 12usize];
    ["Alignment of FormatterScreenExtra"][::std::mem::align_of::<FormatterScreenExtra>() - 4usize];
    ...
    ["Offset of field: FormatterScreenExtra::cursor"]
        [::std::mem::offset_of!(FormatterScreenExtra, cursor) - 4usize];
    ["Offset of field: FormatterScreenExtra::style"]
        [::std::mem::offset_of!(FormatterScreenExtra, style) - 5usize];
    ["Offset of field: FormatterScreenExtra::hyperlink"]
        [::std::mem::offset_of!(FormatterScreenExtra, hyperlink) - 6usize];
    ["Offset of field: FormatterScreenExtra::protection"]
        [::std::mem::offset_of!(FormatterScreenExtra, protection) - 7usize];
    ["Offset of field: FormatterScreenExtra::kitty_keyboard"]
        [::std::mem::offset_of!(FormatterScreenExtra, kitty_keyboard) - 8usize];
    ["Offset of field: FormatterScreenExtra::charsets"]
        [::std::mem::offset_of!(FormatterScreenExtra, charsets) - 9usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of FormatterTerminalExtra"][::std::mem::size_of::<FormatterTerminalExtra>() - 24usize];
    ["Alignment of FormatterTerminalExtra"]
        [::std::mem::align_of::<FormatterTerminalExtra>() - 4usize];
    ...
    ["Offset of field: FormatterTerminalExtra::palette"]
        [::std::mem::offset_of!(FormatterTerminalExtra, palette) - 4usize];
    ["Offset of field: FormatterTerminalExtra::modes"]
        [::std::mem::offset_of!(FormatterTerminalExtra, modes) - 5usize];
    ["Offset of field: FormatterTerminalExtra::scrolling_region"]
        [::std::mem::offset_of!(FormatterTerminalExtra, scrolling_region) - 6usize];
    ["Offset of field: FormatterTerminalExtra::tabstops"]
        [::std::mem::offset_of!(FormatterTerminalExtra, tabstops) - 7usize];
    ["Offset of field: FormatterTerminalExtra::pwd"]
        [::std::mem::offset_of!(FormatterTerminalExtra, pwd) - 8usize];
    ["Offset of field: FormatterTerminalExtra::keyboard"]
        [::std::mem::offset_of!(FormatterTerminalExtra, keyboard) - 9usize];
    ["Offset of field: FormatterTerminalExtra::screen"]
        [::std::mem::offset_of!(FormatterTerminalExtra, screen) - 12usize];
};
...
const _: () = {
    ["Size of FormatterTerminalOptions"]
        [::std::mem::size_of::<FormatterTerminalOptions>() - 40usize];
    ["Alignment of FormatterTerminalOptions"]
        [::std::mem::align_of::<FormatterTerminalOptions>() - 4usize];
    ...
    ["Offset of field: FormatterTerminalOptions::emit"]
        [::std::mem::offset_of!(FormatterTerminalOptions, emit) - 4usize];
    ["Offset of field: FormatterTerminalOptions::unwrap"]
        [::std::mem::offset_of!(FormatterTerminalOptions, unwrap) - 8usize];
    ["Offset of field: FormatterTerminalOptions::trim"]
        [::std::mem::offset_of!(FormatterTerminalOptions, trim) - 9usize];
    ["Offset of field: FormatterTerminalOptions::extra"]
        [::std::mem::offset_of!(FormatterTerminalOptions, extra) - 12usize];
    ["Offset of field: FormatterTerminalOptions::selection"]
        [::std::mem::offset_of!(FormatterTerminalOptions, selection) - 36usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of RenderStateColors"][::std::mem::size_of::<RenderStateColors>() - 784usize];
    ["Alignment of RenderStateColors"][::std::mem::align_of::<RenderStateColors>() - 4usize];
    ...
    ["Offset of field: RenderStateColors::background"]
        [::std::mem::offset_of!(RenderStateColors, background) - 4usize];
    ["Offset of field: RenderStateColors::foreground"]
        [::std::mem::offset_of!(RenderStateColors, foreground) - 7usize];
    ["Offset of field: RenderStateColors::cursor"]
        [::std::mem::offset_of!(RenderStateColors, cursor) - 10usize];
    ["Offset of field: RenderStateColors::cursor_has_value"]
        [::std::mem::offset_of!(RenderStateColors, cursor_has_value) - 13usize];
    ["Offset of field: RenderStateColors::palette"]
        [::std::mem::offset_of!(RenderStateColors, palette) - 14usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of SgrUnknown"][::std::mem::size_of::<SgrUnknown>() - 16usize];
    ["Alignment of SgrUnknown"][::std::mem::align_of::<SgrUnknown>() - 4usize];
    ["Offset of field: SgrUnknown::full_ptr"]
        [::std::mem::offset_of!(SgrUnknown, full_ptr) - 0usize];
    ["Offset of field: SgrUnknown::full_len"]
        [::std::mem::offset_of!(SgrUnknown, full_len) - 4usize];
    ["Offset of field: SgrUnknown::partial_ptr"]
        [::std::mem::offset_of!(SgrUnknown, partial_ptr) - 8usize];
    ["Offset of field: SgrUnknown::partial_len"]
        [::std::mem::offset_of!(SgrUnknown, partial_len) - 12usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of SysImage"][::std::mem::size_of::<SysImage>() - 16usize];
    ["Alignment of SysImage"][::std::mem::align_of::<SysImage>() - 4usize];
    ...
    ["Offset of field: SysImage::data_len"][::std::mem::offset_of!(SysImage, data_len) - 12usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MouseEncoderSize"][::std::mem::size_of::<MouseEncoderSize>() - 36usize];
    ["Alignment of MouseEncoderSize"][::std::mem::align_of::<MouseEncoderSize>() - 4usize];
    ...
    ["Offset of field: MouseEncoderSize::screen_width"]
        [::std::mem::offset_of!(MouseEncoderSize, screen_width) - 4usize];
    ["Offset of field: MouseEncoderSize::screen_height"]
        [::std::mem::offset_of!(MouseEncoderSize, screen_height) - 8usize];
    ["Offset of field: MouseEncoderSize::cell_width"]
        [::std::mem::offset_of!(MouseEncoderSize, cell_width) - 12usize];
    ["Offset of field: MouseEncoderSize::cell_height"]
        [::std::mem::offset_of!(MouseEncoderSize, cell_height) - 16usize];
    ["Offset of field: MouseEncoderSize::padding_top"]
        [::std::mem::offset_of!(MouseEncoderSize, padding_top) - 20usize];
    ["Offset of field: MouseEncoderSize::padding_bottom"]
        [::std::mem::offset_of!(MouseEncoderSize, padding_bottom) - 24usize];
    ["Offset of field: MouseEncoderSize::padding_right"]
        [::std::mem::offset_of!(MouseEncoderSize, padding_right) - 28usize];
    ["Offset of field: MouseEncoderSize::padding_left"]
        [::std::mem::offset_of!(MouseEncoderSize, padding_left) - 32usize];
};
